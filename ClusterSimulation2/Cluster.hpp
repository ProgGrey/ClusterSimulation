...
public:
    ...
    // Указатель на распределение количества пользователей системы после завершения симуляции
    DynamicArraySimple<double, 100000000>* p_x_stat_last_pointer;
    // Указатель на распределение фаз в повышеном и пониженом режимах после завершения симуляции
